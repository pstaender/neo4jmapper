...
var Graph, Join, Neo4j, Node, SkipInBrowser, SkipInNode, client, configForTest, expect, graphdb, helpers, neo4jmapper, version, _, _ref,
...
describe('Neo4jMapper', function() {
  ...
  describe('node', function() {
    it('expect to allow inheritance', function(done) {
      var Movie, Person, movie, person, _ref1;
      Person = (function(_super) {
        __extends(Person, _super);
              ...
              return jeff.allLabels(function(err, labels) {
                ...
                return jeff.replaceLabels(['Person'], function(err) {
                  ...
                  return jeff.allLabels(function(err, labels) {
                    ...
                    expect(labels).to.have.length(1);
                    expect(labels[0]).to.be.equal('Person');
                    return Person.findById(jeff.id, function(err, found) {
                      expect(err).to.be(null);
